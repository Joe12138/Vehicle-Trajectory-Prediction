...
class EnvViewer(object):
    ...
    def __init__(self, env, offscreen=False):
        ...
        # A display is not mandatory to draw things. Ignoring the display.set_mode() instruction allows the drawing to
        # be done on surfaces without handling a screen display, useful for e.g. cloud computing
        ...
        self.sim_surface.centering_position = env.config.get("centering_position", self.sim_surface.INITIAL_SCALING)
    ...
    def display(self):
        ...
        if self.SAVE_IMAGES:
            pygame.image.save(self.screen,
                              "/home/joe/Prediction/OurCode/IRL/NGSIM_env/envs/Pics/ngsim_highway_env_{}.png".
                              format(self.frame))
            self.frame += 1

    def get_image(self):
        """
        :return: the rendered image as a rgb array
        """
